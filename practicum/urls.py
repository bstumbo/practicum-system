...
urlpatterns = [
    ...
    path('student/practicum-plan/<uuid:projectplan_id>/add-hours', views.addHours, name='add-hours-form'),
    path('edit-hours/<uuid:hours_id>', views.editHours, name='edit-hours-form'),

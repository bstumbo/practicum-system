...
urlpatterns = [
    ...
    path('practicum-director/practicum-plan/<int:projectplan_id>', views.practicumDirectorPlanApproval,
         name='practicum-director-plan-approval'),
    path('practicum-director/practicum-plan/pdapprove/<int:projectplan_id>', views.practicumDirectorPlanApproval,
         name='practicum-director-plan-pdapprove'),
    path('practicum-director/practicum-plan/precepapprove/<int:projectplan_id>', views.practicumDirectorPlanApproval,
         name='practicum-director-plan-precepapprove'),
    path('practicum-director/midpoint-evaluation/<int:midpointevaluation_id>', views.practicumMidpointEvaluationApproval,
         name='practicum-director-midpoint-evaluation-approval'),
    path('practicum-director/final-evaluation/<int:finalevaluation_id>', views.practicumFinalEvaluationApproval,
